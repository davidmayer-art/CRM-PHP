...
//require('fpdf/ChiffresEnLettres.php');
    ...
    While ($num_page <= $nb_page)
    {
        ...
        { 
            ...
            $nom_file = substr($data['pdf'],0,-4);
            $nom_file = $nom_file.'_duplicata.pdf';
            ...
            $pdf->SetXY( 50, 30 ); $pdf->SetFont('Arial','B',15); $pdf->Cell( 110, 7, utf8_decode("Duplicata "), 0, 1, 'C');
            ...
            if ($data['nom_societe']!= "" or !isset($data['nom_societe']) or !empty($data['nom_societe'])){
                if ($data['nom']=="" && $data['prenom']==""){
                    ...
                    // $pdf->SetXY( 2, 138 ); $pdf->SetFont('Arial','B',10); $pdf->Cell( 60, 10, "Nom :", 0, 1, 'C');$pdf->SetXY( 20, 138 ); $pdf->SetFont('Arial','B',10); $pdf->Cell( 103, 10,'M. TENENHAUS Mathias', 0, 1, 'C');
